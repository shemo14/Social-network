...
@section('content')
                ...
                <div class="post-content">
                    <img src="{{ Request::root() }}/website/images/post-images/2.jpg" alt="post-image" class="img-responsive post-image" />
                    <div class="post-container">
                        ...
                        <div class="post-detail">
                            ...
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-11.jpg" alt="" class="profile-photo-sm" />
                                <p><a href="timeline.html" class="profile-link">Diana </a><i class="em em-laughing"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                            </div>
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-4.jpg" alt="" class="profile-photo-sm" />
                ...
                ================================================= -->
                <div class="post-content">
                    <video class="post-video" controls> <source src="{{ Request::root() }}/website/videos/8.mp4" type="video/mp4"> </video>
                    <div class="post-container">
                        <img src="{{ Request::root() }}/website/images/users/user-3.jpg" alt="user" class="profile-photo-md pull-left" />
                        <div class="post-detail">
                            <div class="user-info">
                            ...
                            <div class="line-divider"></div>
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-14.jpg" alt="" class="profile-photo-sm" />
                            ...
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-2.jpg" alt="" class="profile-photo-sm" />
                ...
                <div class="post-content">
                    <div class="post-container">
                        <img src="{{ Request::root() }}/website/images/users/user-2.jpg" alt="user" class="profile-photo-md pull-left" />
                        <div class="post-detail">
                            <div class="user-info">
                            ...
                            <div class="line-divider"></div>
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-12.jpg" alt="" class="profile-photo-sm" />
                ...
                <div class="post-content">
                    <img src="{{ Request::root() }}/website/images/post-images/2.jpg" alt="post-image" class="img-responsive post-image" />
                    <div class="post-container">
                        <img src="{{ Request::root() }}/website/images/users/user-4.jpg" alt="user" class="profile-photo-md pull-left" />
                        <div class="post-detail">
                            <div class="user-info">
                            ...
                            <div class="line-divider"></div>
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-13.jpg" alt="" class="profile-photo-sm" />
                            ...
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-8.jpg" alt="" class="profile-photo-sm" />
                ...
                ================================================= -->
                <div class="post-content">
                    <img src="{{ Request::root() }}/website/images/post-images/11.jpg" alt="" class="img-responsive post-image" />
                    <div class="post-container">
                        <img src="{{ Request::root() }}/website/images/users/user-9.jpg" alt="user" class="profile-photo-md pull-left" />
                        <div class="post-detail">
                            <div class="user-info">
                            ...
                            <div class="line-divider"></div>
                            <div class="post-comment">
                                <img src="{{ Request::root() }}/website/images/users/user-10.jpg" alt="" class="profile-photo-sm" />
